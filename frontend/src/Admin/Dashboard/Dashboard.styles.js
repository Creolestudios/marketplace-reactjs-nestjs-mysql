...
.filter-category .ant-form .ant-select:not(.ant-select-customize-input) .ant-select-selector .ant-select-selection-item {
  line-height: 34px;
  text-align: left;
  color: #423f3f;
}
.filter-category .ant-select-selector {
...
.isoLayoutContentWrapper{
  ...
  .suspend-btn 
  {
    ...
    &.activate-btn{
      &:hover{
        border-color: #0fd346 !important;
        /* color: #0fd346 !important; */
        span{
          color: #0fd346 !important;
        }
      }
  ...
  h2.ant-typography{
    ...
    align-items: center;
    margin: 0;
    color: #423F3F;position: relative;
    width: 97%;
    white-space: nowrap;
    &::after{
      content: '';
